   ...
   String mensaje = "Seleccione el horario del auditorio que desea liberar:\n" +
    ...
    try {
      ...
      if (opcion == 1) {
        if (cuposAuditorioAM < 50) {
            cuposAuditorioAM = 50;
            JOptionPane.showMessageDialog(null, "Auditorio de 10:00 AM liberado correctamente.");
        } else {
        ...
        if (cuposAuditorioPM < 50) {
            cuposAuditorioPM = 50;
            JOptionPane.showMessageDialog(null, "Auditorio de 3:00 PM liberado correctamente.");
        } else {
